...
public class ExampleEventInstantiator implements IEventInstantiator {
    ...
    @Override
    public Map<String, IObservation> createEvents(ITransition transition, Map<String, IState> inputs) throws KlabException {
    	// TODO 
